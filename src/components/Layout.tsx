      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-white/60 text-sm">
            <li><Link to="/quero-vender" className="hover:text-white transition-colors">Quero Vender</Link></li>
            <li><Link to="/quero-comprar" className="hover:text-white transition-colors">Quero Comprar</Link></li>
