...
const DIFERENCIAIS_CORRETOR = [
  {
    ...
    items: [
      ...
      'Programa de Formação de Corretores REMAX',
  ...
  },
  {
    ...
    items: [
      ...
      'Consultoria personalizada do primeiro contato ao fechamento',
    ],
  },
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Programa de certificação exclusivo</h2>
            ...
            <div className="space-y-4 mb-10">
              {['Treinamentos técnicos especializados no agro','Programa de Formação de Corretores REMAX','Participação ativa em eventos do agronegócio','Planos de desenvolvimento individual','Certificação REMAX Agro exclusiva'].map((item, i) => (
